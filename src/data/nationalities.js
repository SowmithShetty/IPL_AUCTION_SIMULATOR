...
const ZA = ['F. du Plessis', 'D. Miller', 'A. Markram', 'R. Rossouw', 'H. Klaasen', 'Q. de Kock', 'T. Stubbs', 'R. Rickelton', 'K. Rabada', 'A. Nortje', 'M. Jansen', 'L. Ngidi', 'G. Coetzee', 'N. Burger', 'D. Brevis', 'A. Phehlukwayo', 'W. Parnell', 'M. de Lange', 'K. Abbott', 'D. Wiese', 'G. Roelofsen', 'C. Fortuin', 'S. Erwee', 'M. Breetzke', 'R. Hendricks'];
...
const NZ = ['K. Williamson', 'D. Conway', 'R. Ravindra', 'T. Boult', 'L. Ferguson', 'M. Santner', 'D. Mitchell', 'G. Phillips', 'T. Southee', 'M. Henry', 'K. Jamieson', 'M. Guptill', 'C. Munro', 'J. Neesham', 'M. Bracewell', 'H. Kerr', 'D. Cleaver', 'T. Seifert', 'T. Blundell', 'A. Milne', 'I. Sodhi'];
...
const LK = ['M. Pathirana', 'M. Theekshana', 'W. Hasaranga', 'D. Chameera', 'M. Bhanuka', 'C. Asalanka', 'K. Mendis', 'D. Shanaka', 'P. Nissanka', 'T. Perera', 'A. Mathews'];
